...
const ProfileImageMap: Record<string, string> = {
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_dao.png?alt=media&token=4d8e01e4-8d52-441f-a73b-b43aaea9b1bc":
    "/profile/gyool_dao.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_dao.png?alt=media&token=07110f66-9806-4e10-aa84-2b3e83c9d450":
    "/profile/jakong_dao.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_dizini.png?alt=media&token=52ea802f-6434-4f9f-a03f-3de86c21a308":
    "/profile/gyool_dizini.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_dizini.png?alt=media&token=9ee023f2-22be-434d-ac2a-6072c03dd7d9":
    "/profile/jakong_dizini.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_bazzi.png?alt=media&token=1f427adf-ae22-4f05-b704-821a46b6b37a":
    "/profile/gyool_bazzi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_bazzi.png?alt=media&token=a2f49070-931b-4def-a196-7ae5e442fd3b":
    "/profile/jakong_bazzi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_marid.png?alt=media&token=fb2dd66c-e573-44f1-b4fd-f88babc6143c":
    "/profile/gyool_marid.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_marid.png?alt=media&token=a6b5a54f-088e-4153-a682-cfaa13e2f853":
    "/profile/jakong_marid.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_eddi.png?alt=media&token=40398f31-5b97-4fb4-a35a-d3c7d079f307":
    "/profile/gyool_eddi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_eddi.png?alt=media&token=e4a324b4-dc21-4588-8617-193183304437":
    "/profile/jakong_eddi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_uni.png?alt=media&token=4bdd693c-9c66-43e5-aba5-d821a7ddd22e":
    "/profile/gyool_uni.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_uni.png?alt=media&token=5c5c5d67-82ab-41d1-8e25-c7b4d2572f09":
    "/profile/jakong_uni.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_kepi.png?alt=media&token=26860945-3bd0-4735-9241-ad6fdcd493b1":
    "/profile/gyool_kepi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_keppi.png?alt=media&token=61d6e072-ff9e-49b8-bb2b-4d55fdba148a":
    "/profile/jakong_keppi.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fgyool%2Fgyool_rodumani.png?alt=media&token=2c59f00a-e142-4b53-bc39-19c316917b7f":
    "/profile/gyool_rodumani.png",
  "https://firebasestorage.googleapis.com/v0/b/kart-chu-club.appspot.com/o/licenseImages%2Fjakong%2Fjakong_rodumani.png?alt=media&token=9cd7a121-9842-4fdf-a65c-0bfd02c00d46":
    "/profile/jakong_rodumani.png",
};
  ...
  for (const user of users) {
    try {
      ...
      if (oldImage && ProfileImageMap[oldImage]) {
        ...
        console.log(
          `Warning: Unknown image URL for user ${user._id}: ${oldImage}`,
        );
      ...
      console.log(
        `User ${user.name} migrated (image: ${oldImage?.substring(0, 50)}... → ${newImage})`,
      );
    } catch (error) {
      stats.users.errors++;
...
async function migrateLogs(
  ...
  userMap: Map<string, { nickname: string; profilePicture: string }>,
) {
  console.log("\n=== Migrating Logs ===");
  const db = mongoose.connection.db;
...
async function migrateRecords(stats: MigrationStats) {
  ...
  stats.records.total = totalCount;
  ...
  while (skip < totalCount) {
    ...
    console.log(
      `Processing batch ${Math.floor(skip / BATCH_SIZE) + 1} (${skip + 1} to ${skip + records.length})`,
    );
      ...
      try {
        ...
        for (const oldRec of oldRecords) {
          ...
          if (currentIndex < mapCount.Rookie) {
            ...
            currentIndex <
            mapCount.Rookie + mapCount.L3 + mapCount.L2
          ) {
            difficulty = "L2";
          } else {
            difficulty = "L1";
        ...
        stats.records.migrated++;
        if (stats.records.migrated % 100 === 0) {
          console.log(
            `Progress: ${stats.records.migrated}/${totalCount} records migrated`,
          );
        }
      } catch (error) {
  ...
  console.log(
    `Records migration completed: ${stats.records.migrated}/${totalCount}`,
  );
}

async function buildUserMap(): Promise<
  Map<string, { nickname: string; profilePicture: string }>
> {
  console.log("\n=== Building User Map ===");
  const db = mongoose.connection.db;
  const usersCollection = db!.collection("users");
  ...
  const userMap = new Map<
    string,
    { nickname: string; profilePicture: string }
  >();
  ...
  for (const user of users) {
    ...
    if (profilePicture.startsWith("https://firebasestorage")) {
      profilePicture =
        ProfileImageMap[profilePicture] || "/profile/gyool_dizini.png";
    }
...
async function main() {
  ...
  try {
    ...
    console.log(
      `Announcements: ${stats.announcements.migrated}/${stats.announcements.total} (${stats.announcements.errors} errors)`,
    );
    console.log(
      `Feedbacks: ${stats.feedbacks.migrated}/${stats.feedbacks.total} (${stats.feedbacks.errors} errors)`,
    );
    console.log(
      `Logs: ${stats.logs.migrated}/${stats.logs.total} (${stats.logs.errors} errors)`,
    );
    console.log(
      `Records: ${stats.records.migrated}/${stats.records.total} (${stats.records.errors} errors)`,
    );
