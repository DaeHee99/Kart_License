...
export function TierIntroduction() {
            ...
            {tierOrder.map((tierId, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Card
                    className="hover:border-primary/50 from-card via-card to-muted/30 relative cursor-pointer overflow-hidden border-2 bg-linear-to-br p-4 transition-all hover:shadow-2xl"
