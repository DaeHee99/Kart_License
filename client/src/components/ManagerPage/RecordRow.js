    ...
    <tr>
          ...
          <MDBTableBody>
            <tr>
              <th
                ...
                style={{ backgroundColor: "rgba(255, 99, 132, 0.5)" }}
              >
                {props.data.recordCount[0]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(255, 159, 64, 0.5)" }}
              >
                {props.data.recordCount[1]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(255, 205, 86, 0.5)" }}
              >
                {props.data.recordCount[2]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(75, 192, 192, 0.5)" }}
              >
                {props.data.recordCount[3]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(54, 162, 235, 0.5)" }}
              >
                {props.data.recordCount[4]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(153, 102, 255, 0.5)" }}
              >
                {props.data.recordCount[5]}
              </th>
              <th
                scope="row"
                style={{ backgroundColor: "rgba(201, 203, 207, 0.5)" }}
              >
                {props.data.recordCount[6]}
              </th>
            </tr>
          </MDBTableBody>
        </table>
      ...
      <td>
        <MDBBtn
          ...
          onClick={() => navigation(`/result/${props.data._id}`)}
        >
          <b>결과</b>
        </MDBBtn>
      </td>
