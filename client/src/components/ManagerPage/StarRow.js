    ...
    <tr>
      ...
      <td>
        ...
        <MDBBtn
          ...
          onClick={() => navigation(`/result/${props.data.recordId}`)}
        >
          <b>결과 페이지</b>
        </MDBBtn>
      </td>
      <td style={{ wordBreak: "break-all" }}>
        ...
        >
          <MDBIcon
            far={props.data.star < 1}
            fas={props.data.star >= 1}
            icon="star"
            size="lg"
          />
          <MDBIcon
            far={props.data.star < 2}
            fas={props.data.star >= 2}
            icon="star"
            size="lg"
          />
          <MDBIcon
            far={props.data.star < 3}
            fas={props.data.star >= 3}
            icon="star"
            size="lg"
          />
          <MDBIcon
            far={props.data.star < 4}
            fas={props.data.star >= 4}
            icon="star"
            size="lg"
          />
          <MDBIcon
            far={props.data.star < 5}
            fas={props.data.star >= 5}
            icon="star"
            size="lg"
          />
        </div>
